...
/* src/icons/IconEyeDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "eye-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEyeDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEyeDown$1 = IconEyeDown;

export { IconEyeDown$1 as default };
//# sourceMappingURL=IconEyeDown.svelte.js.map
