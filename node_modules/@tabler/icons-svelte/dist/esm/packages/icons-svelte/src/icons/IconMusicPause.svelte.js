...
/* src/icons/IconMusicPause.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "music-pause" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMusicPause extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMusicPause$1 = IconMusicPause;

export { IconMusicPause$1 as default };
//# sourceMappingURL=IconMusicPause.svelte.js.map
