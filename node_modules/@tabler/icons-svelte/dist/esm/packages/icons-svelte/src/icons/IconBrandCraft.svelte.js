...
/* src/icons/IconBrandCraft.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-craft" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandCraft extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandCraft$1 = IconBrandCraft;

export { IconBrandCraft$1 as default };
//# sourceMappingURL=IconBrandCraft.svelte.js.map
