...
/* src/icons/IconPick.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pick" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPick extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPick$1 = IconPick;

export { IconPick$1 as default };
//# sourceMappingURL=IconPick.svelte.js.map
