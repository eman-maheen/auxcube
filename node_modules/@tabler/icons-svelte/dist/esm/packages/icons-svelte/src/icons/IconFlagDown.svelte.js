...
/* src/icons/IconFlagDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flag-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlagDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlagDown$1 = IconFlagDown;

export { IconFlagDown$1 as default };
//# sourceMappingURL=IconFlagDown.svelte.js.map
