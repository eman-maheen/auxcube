...
/* src/icons/IconInputCheck.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "input-check" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconInputCheck extends SvelteComponent {
	constructor(options) {
		super();
...
var IconInputCheck$1 = IconInputCheck;

export { IconInputCheck$1 as default };
//# sourceMappingURL=IconInputCheck.svelte.js.map
