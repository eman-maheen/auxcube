...
/* src/icons/IconPencilX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pencil-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPencilX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPencilX$1 = IconPencilX;

export { IconPencilX$1 as default };
//# sourceMappingURL=IconPencilX.svelte.js.map
