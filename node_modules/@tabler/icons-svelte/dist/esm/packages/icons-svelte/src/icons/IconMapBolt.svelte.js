...
/* src/icons/IconMapBolt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-bolt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapBolt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapBolt$1 = IconMapBolt;

export { IconMapBolt$1 as default };
//# sourceMappingURL=IconMapBolt.svelte.js.map
