...
/* src/icons/IconWashHand.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wash-hand" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWashHand extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWashHand$1 = IconWashHand;

export { IconWashHand$1 as default };
//# sourceMappingURL=IconWashHand.svelte.js.map
