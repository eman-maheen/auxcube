...
/* src/icons/IconHeartBolt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "heart-bolt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHeartBolt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHeartBolt$1 = IconHeartBolt;

export { IconHeartBolt$1 as default };
//# sourceMappingURL=IconHeartBolt.svelte.js.map
