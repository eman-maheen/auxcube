...
/* src/icons/IconMapPause.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-pause" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapPause extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapPause$1 = IconMapPause;

export { IconMapPause$1 as default };
//# sourceMappingURL=IconMapPause.svelte.js.map
