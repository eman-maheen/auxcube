...
/* src/icons/IconMusicStar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "music-star" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMusicStar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMusicStar$1 = IconMusicStar;

export { IconMusicStar$1 as default };
//# sourceMappingURL=IconMusicStar.svelte.js.map
