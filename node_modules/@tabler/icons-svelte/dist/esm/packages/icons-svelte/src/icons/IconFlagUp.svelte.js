...
/* src/icons/IconFlagUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flag-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlagUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlagUp$1 = IconFlagUp;

export { IconFlagUp$1 as default };
//# sourceMappingURL=IconFlagUp.svelte.js.map
