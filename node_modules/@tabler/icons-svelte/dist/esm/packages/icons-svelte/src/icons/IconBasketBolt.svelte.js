...
/* src/icons/IconBasketBolt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "basket-bolt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBasketBolt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBasketBolt$1 = IconBasketBolt;

export { IconBasketBolt$1 as default };
//# sourceMappingURL=IconBasketBolt.svelte.js.map
