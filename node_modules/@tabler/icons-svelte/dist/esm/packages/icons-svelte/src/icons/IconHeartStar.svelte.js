...
/* src/icons/IconHeartStar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "heart-star" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHeartStar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHeartStar$1 = IconHeartStar;

export { IconHeartStar$1 as default };
//# sourceMappingURL=IconHeartStar.svelte.js.map
