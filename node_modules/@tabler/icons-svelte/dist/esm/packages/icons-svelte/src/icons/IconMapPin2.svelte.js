...
/* src/icons/IconMapPin2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-pin-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [
		[
			"path",
			{
				"d": "M12 18.5l-3 -1.5l-6 3v-13l6 -3l6 3l6 -3v7"
			}
		],
		["path", { "d": "M9 4v13" }],
		["path", { "d": "M15 7v5" }],
...
class IconMapPin2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapPin2$1 = IconMapPin2;

export { IconMapPin2$1 as default };
//# sourceMappingURL=IconMapPin2.svelte.js.map
