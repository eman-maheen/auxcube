...
/* src/icons/IconFlagCancel.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flag-cancel" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlagCancel extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlagCancel$1 = IconFlagCancel;

export { IconFlagCancel$1 as default };
//# sourceMappingURL=IconFlagCancel.svelte.js.map
