...
/* src/icons/IconEyeCancel.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "eye-cancel" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEyeCancel extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEyeCancel$1 = IconEyeCancel;

export { IconEyeCancel$1 as default };
//# sourceMappingURL=IconEyeCancel.svelte.js.map
