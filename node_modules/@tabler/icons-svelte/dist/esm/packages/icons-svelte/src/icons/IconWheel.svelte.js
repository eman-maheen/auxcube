...
/* src/icons/IconWheel.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wheel" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWheel extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWheel$1 = IconWheel;

export { IconWheel$1 as default };
//# sourceMappingURL=IconWheel.svelte.js.map
