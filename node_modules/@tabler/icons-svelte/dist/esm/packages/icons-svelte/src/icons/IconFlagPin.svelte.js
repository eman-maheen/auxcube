...
/* src/icons/IconFlagPin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flag-pin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlagPin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlagPin$1 = IconFlagPin;

export { IconFlagPin$1 as default };
//# sourceMappingURL=IconFlagPin.svelte.js.map
