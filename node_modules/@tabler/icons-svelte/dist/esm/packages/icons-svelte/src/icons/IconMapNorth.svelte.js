...
/* src/icons/IconMapNorth.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-north" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapNorth extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapNorth$1 = IconMapNorth;

export { IconMapNorth$1 as default };
//# sourceMappingURL=IconMapNorth.svelte.js.map
