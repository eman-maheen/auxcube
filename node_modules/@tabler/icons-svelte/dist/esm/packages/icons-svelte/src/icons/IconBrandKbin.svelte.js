...
/* src/icons/IconBrandKbin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-kbin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["g", { "stroke-width": "1.838" }]];
...
class IconBrandKbin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandKbin$1 = IconBrandKbin;

export { IconBrandKbin$1 as default };
//# sourceMappingURL=IconBrandKbin.svelte.js.map
