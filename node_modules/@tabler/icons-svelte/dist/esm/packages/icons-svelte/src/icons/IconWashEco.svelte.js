...
/* src/icons/IconWashEco.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wash-eco" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWashEco extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWashEco$1 = IconWashEco;

export { IconWashEco$1 as default };
//# sourceMappingURL=IconWashEco.svelte.js.map
