...
/* src/icons/IconMapPlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapPlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapPlus$1 = IconMapPlus;

export { IconMapPlus$1 as default };
//# sourceMappingURL=IconMapPlus.svelte.js.map
