...
/* src/icons/IconLadle.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ladle" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLadle extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLadle$1 = IconLadle;

export { IconLadle$1 as default };
//# sourceMappingURL=IconLadle.svelte.js.map
