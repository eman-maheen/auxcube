...
/* src/icons/IconOctahedron.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "octahedron" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconOctahedron extends SvelteComponent {
	constructor(options) {
		super();
...
var IconOctahedron$1 = IconOctahedron;

export { IconOctahedron$1 as default };
//# sourceMappingURL=IconOctahedron.svelte.js.map
