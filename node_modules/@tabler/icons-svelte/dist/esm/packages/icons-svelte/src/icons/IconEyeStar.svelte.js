...
/* src/icons/IconEyeStar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "eye-star" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEyeStar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEyeStar$1 = IconEyeStar;

export { IconEyeStar$1 as default };
//# sourceMappingURL=IconEyeStar.svelte.js.map
