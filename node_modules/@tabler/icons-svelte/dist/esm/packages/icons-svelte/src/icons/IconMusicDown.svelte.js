...
/* src/icons/IconMusicDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "music-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMusicDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMusicDown$1 = IconMusicDown;

export { IconMusicDown$1 as default };
//# sourceMappingURL=IconMusicDown.svelte.js.map
