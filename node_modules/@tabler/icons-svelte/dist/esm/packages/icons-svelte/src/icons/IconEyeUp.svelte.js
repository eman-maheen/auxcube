...
/* src/icons/IconEyeUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "eye-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEyeUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEyeUp$1 = IconEyeUp;

export { IconEyeUp$1 as default };
//# sourceMappingURL=IconEyeUp.svelte.js.map
