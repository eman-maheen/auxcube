...
/* src/icons/IconMapUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapUp$1 = IconMapUp;

export { IconMapUp$1 as default };
//# sourceMappingURL=IconMapUp.svelte.js.map
