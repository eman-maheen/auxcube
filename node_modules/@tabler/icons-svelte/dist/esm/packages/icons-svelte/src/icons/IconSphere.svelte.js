...
/* src/icons/IconSphere.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sphere" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSphere extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSphere$1 = IconSphere;

export { IconSphere$1 as default };
//# sourceMappingURL=IconSphere.svelte.js.map
