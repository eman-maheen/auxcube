...
/* src/icons/IconSphereOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sphere-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSphereOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSphereOff$1 = IconSphereOff;

export { IconSphereOff$1 as default };
//# sourceMappingURL=IconSphereOff.svelte.js.map
