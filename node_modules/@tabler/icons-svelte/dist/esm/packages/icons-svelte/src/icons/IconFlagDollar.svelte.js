...
/* src/icons/IconFlagDollar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flag-dollar" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlagDollar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlagDollar$1 = IconFlagDollar;

export { IconFlagDollar$1 as default };
//# sourceMappingURL=IconFlagDollar.svelte.js.map
