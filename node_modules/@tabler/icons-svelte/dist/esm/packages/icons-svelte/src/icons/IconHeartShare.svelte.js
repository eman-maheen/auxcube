...
/* src/icons/IconHeartShare.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "heart-share" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHeartShare extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHeartShare$1 = IconHeartShare;

export { IconHeartShare$1 as default };
//# sourceMappingURL=IconHeartShare.svelte.js.map
