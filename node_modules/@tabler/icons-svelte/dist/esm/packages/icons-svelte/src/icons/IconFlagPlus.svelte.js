...
/* src/icons/IconFlagPlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flag-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlagPlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlagPlus$1 = IconFlagPlus;

export { IconFlagPlus$1 as default };
//# sourceMappingURL=IconFlagPlus.svelte.js.map
