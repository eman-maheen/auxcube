...
/* src/icons/IconRowRemove.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "row-remove" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRowRemove extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRowRemove$1 = IconRowRemove;

export { IconRowRemove$1 as default };
//# sourceMappingURL=IconRowRemove.svelte.js.map
