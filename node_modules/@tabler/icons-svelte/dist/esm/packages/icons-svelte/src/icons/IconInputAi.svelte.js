...
/* src/icons/IconInputAi.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "input-ai" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconInputAi extends SvelteComponent {
	constructor(options) {
		super();
...
var IconInputAi$1 = IconInputAi;

export { IconInputAi$1 as default };
//# sourceMappingURL=IconInputAi.svelte.js.map
