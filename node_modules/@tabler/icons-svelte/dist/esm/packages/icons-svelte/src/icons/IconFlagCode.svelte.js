...
/* src/icons/IconFlagCode.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flag-code" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlagCode extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlagCode$1 = IconFlagCode;

export { IconFlagCode$1 as default };
//# sourceMappingURL=IconFlagCode.svelte.js.map
