...
/* src/icons/IconGhost3.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ghost-3" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGhost3 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGhost3$1 = IconGhost3;

export { IconGhost3$1 as default };
//# sourceMappingURL=IconGhost3.svelte.js.map
