...
/* src/icons/IconMapSouth.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-south" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapSouth extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapSouth$1 = IconMapSouth;

export { IconMapSouth$1 as default };
//# sourceMappingURL=IconMapSouth.svelte.js.map
