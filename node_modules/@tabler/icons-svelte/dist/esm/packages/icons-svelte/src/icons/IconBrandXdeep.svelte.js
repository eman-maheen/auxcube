...
/* src/icons/IconBrandXdeep.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-xdeep" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandXdeep extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandXdeep$1 = IconBrandXdeep;

export { IconBrandXdeep$1 as default };
//# sourceMappingURL=IconBrandXdeep.svelte.js.map
