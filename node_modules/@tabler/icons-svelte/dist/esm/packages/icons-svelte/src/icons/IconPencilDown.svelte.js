...
/* src/icons/IconPencilDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pencil-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPencilDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPencilDown$1 = IconPencilDown;

export { IconPencilDown$1 as default };
//# sourceMappingURL=IconPencilDown.svelte.js.map
