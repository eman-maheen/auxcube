...
/* src/icons/IconDiabolo.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "diabolo" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDiabolo extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDiabolo$1 = IconDiabolo;

export { IconDiabolo$1 as default };
//# sourceMappingURL=IconDiabolo.svelte.js.map
