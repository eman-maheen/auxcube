...
/* src/icons/IconMapShare.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-share" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapShare extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapShare$1 = IconMapShare;

export { IconMapShare$1 as default };
//# sourceMappingURL=IconMapShare.svelte.js.map
