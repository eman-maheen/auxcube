...
/* src/icons/IconBombFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bomb-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBombFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBombFilled$1 = IconBombFilled;

export { IconBombFilled$1 as default };
//# sourceMappingURL=IconBombFilled.svelte.js.map
