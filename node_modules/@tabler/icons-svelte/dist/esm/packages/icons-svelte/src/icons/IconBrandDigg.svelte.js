...
/* src/icons/IconBrandDigg.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-digg" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandDigg extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandDigg$1 = IconBrandDigg;

export { IconBrandDigg$1 as default };
//# sourceMappingURL=IconBrandDigg.svelte.js.map
