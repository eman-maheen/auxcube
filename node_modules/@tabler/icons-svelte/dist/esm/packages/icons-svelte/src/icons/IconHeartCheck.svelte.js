...
/* src/icons/IconHeartCheck.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "heart-check" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHeartCheck extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHeartCheck$1 = IconHeartCheck;

export { IconHeartCheck$1 as default };
//# sourceMappingURL=IconHeartCheck.svelte.js.map
