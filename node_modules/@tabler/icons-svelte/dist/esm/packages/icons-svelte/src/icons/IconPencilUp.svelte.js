...
/* src/icons/IconPencilUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pencil-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPencilUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPencilUp$1 = IconPencilUp;

export { IconPencilUp$1 as default };
//# sourceMappingURL=IconPencilUp.svelte.js.map
