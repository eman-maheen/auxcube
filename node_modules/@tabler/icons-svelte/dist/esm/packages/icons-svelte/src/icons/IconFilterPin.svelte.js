...
/* src/icons/IconFilterPin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "filter-pin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFilterPin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFilterPin$1 = IconFilterPin;

export { IconFilterPin$1 as default };
//# sourceMappingURL=IconFilterPin.svelte.js.map
