...
/* src/icons/IconHdr.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "hdr" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHdr extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHdr$1 = IconHdr;

export { IconHdr$1 as default };
//# sourceMappingURL=IconHdr.svelte.js.map
