...
/* src/icons/IconMapStar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-star" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapStar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapStar$1 = IconMapStar;

export { IconMapStar$1 as default };
//# sourceMappingURL=IconMapStar.svelte.js.map
