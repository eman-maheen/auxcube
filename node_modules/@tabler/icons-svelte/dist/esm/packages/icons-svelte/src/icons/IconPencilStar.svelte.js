...
/* src/icons/IconPencilStar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pencil-star" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPencilStar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPencilStar$1 = IconPencilStar;

export { IconPencilStar$1 as default };
//# sourceMappingURL=IconPencilStar.svelte.js.map
