...
/* src/icons/IconPencilBolt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pencil-bolt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPencilBolt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPencilBolt$1 = IconPencilBolt;

export { IconPencilBolt$1 as default };
//# sourceMappingURL=IconPencilBolt.svelte.js.map
