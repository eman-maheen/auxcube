...
/* src/icons/IconFlagStar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flag-star" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlagStar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlagStar$1 = IconFlagStar;

export { IconFlagStar$1 as default };
//# sourceMappingURL=IconFlagStar.svelte.js.map
