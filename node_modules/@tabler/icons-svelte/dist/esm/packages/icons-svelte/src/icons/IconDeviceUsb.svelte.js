...
/* src/icons/IconDeviceUsb.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "device-usb" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [
		[
			"path",
			{
				"d": "M8 8h8v9a3 3 0 0 1 -3 3h-2a3 3 0 0 1 -3 -3v-9z"
			}
		],
		["path", { "d": "M10 8v-4h4v4" }]
	];
...
class IconDeviceUsb extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDeviceUsb$1 = IconDeviceUsb;

export { IconDeviceUsb$1 as default };
//# sourceMappingURL=IconDeviceUsb.svelte.js.map
