...
/* src/icons/IconFlagX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flag-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlagX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlagX$1 = IconFlagX;

export { IconFlagX$1 as default };
//# sourceMappingURL=IconFlagX.svelte.js.map
