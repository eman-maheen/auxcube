...
/* src/icons/IconShoppingCartHeart.svelte generated by Svelte v3.55.0 */
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [
		...
		[
			"path",
			{
				"d": "M6 5l14 1l-.717 5.016m-7.783 1.984h-5.5"
			}
		],
		[
			"path",
...
class IconShoppingCartHeart extends SvelteComponent {
	constructor(options) {
		super();
...
var IconShoppingCartHeart$1 = IconShoppingCartHeart;

export { IconShoppingCartHeart$1 as default };
//# sourceMappingURL=IconShoppingCartHeart.svelte.js.map
