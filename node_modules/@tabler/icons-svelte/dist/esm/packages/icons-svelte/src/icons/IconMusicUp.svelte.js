...
/* src/icons/IconMusicUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "music-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMusicUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMusicUp$1 = IconMusicUp;

export { IconMusicUp$1 as default };
//# sourceMappingURL=IconMusicUp.svelte.js.map
