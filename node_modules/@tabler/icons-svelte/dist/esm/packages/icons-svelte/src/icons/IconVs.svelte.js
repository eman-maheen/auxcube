...
/* src/icons/IconVs.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "vs" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconVs extends SvelteComponent {
	constructor(options) {
		super();
...
export { IconVs$1 as default };
//# sourceMappingURL=IconVs.svelte.js.map
