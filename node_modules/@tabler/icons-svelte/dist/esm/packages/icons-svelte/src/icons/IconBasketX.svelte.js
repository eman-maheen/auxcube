...
/* src/icons/IconBasketX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "basket-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBasketX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBasketX$1 = IconBasketX;

export { IconBasketX$1 as default };
//# sourceMappingURL=IconBasketX.svelte.js.map
