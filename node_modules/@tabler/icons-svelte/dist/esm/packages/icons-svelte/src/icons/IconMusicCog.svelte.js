...
/* src/icons/IconMusicCog.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "music-cog" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMusicCog extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMusicCog$1 = IconMusicCog;

export { IconMusicCog$1 as default };
//# sourceMappingURL=IconMusicCog.svelte.js.map
