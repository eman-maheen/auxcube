...
/* src/icons/IconMapMinus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-minus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapMinus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapMinus$1 = IconMapMinus;

export { IconMapMinus$1 as default };
//# sourceMappingURL=IconMapMinus.svelte.js.map
