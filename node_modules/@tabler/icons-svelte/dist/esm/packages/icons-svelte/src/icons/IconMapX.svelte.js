...
/* src/icons/IconMapX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapX$1 = IconMapX;

export { IconMapX$1 as default };
//# sourceMappingURL=IconMapX.svelte.js.map
