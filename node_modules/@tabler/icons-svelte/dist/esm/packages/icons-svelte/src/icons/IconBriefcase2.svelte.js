...
/* src/icons/IconBriefcase2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "briefcase-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBriefcase2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBriefcase2$1 = IconBriefcase2;

export { IconBriefcase2$1 as default };
//# sourceMappingURL=IconBriefcase2.svelte.js.map
