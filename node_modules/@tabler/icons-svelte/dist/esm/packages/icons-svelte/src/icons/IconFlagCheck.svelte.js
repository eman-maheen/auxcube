...
/* src/icons/IconFlagCheck.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flag-check" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlagCheck extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlagCheck$1 = IconFlagCheck;

export { IconFlagCheck$1 as default };
//# sourceMappingURL=IconFlagCheck.svelte.js.map
