...
/* src/icons/IconHeartPause.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "heart-pause" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHeartPause extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHeartPause$1 = IconHeartPause;

export { IconHeartPause$1 as default };
//# sourceMappingURL=IconHeartPause.svelte.js.map
