...
/* src/icons/IconMusicCode.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "music-code" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMusicCode extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMusicCode$1 = IconMusicCode;

export { IconMusicCode$1 as default };
//# sourceMappingURL=IconMusicCode.svelte.js.map
