...
/* src/icons/IconBasketCode.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "basket-code" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBasketCode extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBasketCode$1 = IconBasketCode;

export { IconBasketCode$1 as default };
//# sourceMappingURL=IconBasketCode.svelte.js.map
