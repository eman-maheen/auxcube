...
/* src/icons/IconEyePlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "eye-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEyePlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEyePlus$1 = IconEyePlus;

export { IconEyePlus$1 as default };
//# sourceMappingURL=IconEyePlus.svelte.js.map
