...
/* src/icons/IconEyeMinus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "eye-minus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEyeMinus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEyeMinus$1 = IconEyeMinus;

export { IconEyeMinus$1 as default };
//# sourceMappingURL=IconEyeMinus.svelte.js.map
