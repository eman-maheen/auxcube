...
/* src/icons/IconMusicHeart.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "music-heart" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMusicHeart extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMusicHeart$1 = IconMusicHeart;

export { IconMusicHeart$1 as default };
//# sourceMappingURL=IconMusicHeart.svelte.js.map
