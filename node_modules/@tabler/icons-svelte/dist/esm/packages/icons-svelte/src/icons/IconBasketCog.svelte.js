...
/* src/icons/IconBasketCog.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "basket-cog" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBasketCog extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBasketCog$1 = IconBasketCog;

export { IconBasketCog$1 as default };
//# sourceMappingURL=IconBasketCog.svelte.js.map
