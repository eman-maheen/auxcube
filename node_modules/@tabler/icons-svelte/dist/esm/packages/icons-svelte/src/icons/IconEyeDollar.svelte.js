...
/* src/icons/IconEyeDollar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "eye-dollar" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEyeDollar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEyeDollar$1 = IconEyeDollar;

export { IconEyeDollar$1 as default };
//# sourceMappingURL=IconEyeDollar.svelte.js.map
