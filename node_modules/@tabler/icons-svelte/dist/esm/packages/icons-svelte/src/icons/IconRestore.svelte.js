...
/* src/icons/IconRestore.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "restore" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRestore extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRestore$1 = IconRestore;

export { IconRestore$1 as default };
//# sourceMappingURL=IconRestore.svelte.js.map
