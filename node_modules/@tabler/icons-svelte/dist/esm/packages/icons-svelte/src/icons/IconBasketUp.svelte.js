...
/* src/icons/IconBasketUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "basket-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBasketUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBasketUp$1 = IconBasketUp;

export { IconBasketUp$1 as default };
//# sourceMappingURL=IconBasketUp.svelte.js.map
