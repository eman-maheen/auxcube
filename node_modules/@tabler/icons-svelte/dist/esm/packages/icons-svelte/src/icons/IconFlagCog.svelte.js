...
/* src/icons/IconFlagCog.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flag-cog" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlagCog extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlagCog$1 = IconFlagCog;

export { IconFlagCog$1 as default };
//# sourceMappingURL=IconFlagCog.svelte.js.map
