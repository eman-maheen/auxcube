...
/* src/icons/IconHeartUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "heart-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHeartUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHeartUp$1 = IconHeartUp;

export { IconHeartUp$1 as default };
//# sourceMappingURL=IconHeartUp.svelte.js.map
