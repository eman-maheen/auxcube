...
/* src/icons/IconMapEast.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-east" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapEast extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapEast$1 = IconMapEast;

export { IconMapEast$1 as default };
//# sourceMappingURL=IconMapEast.svelte.js.map
