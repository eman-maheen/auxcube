...
/* src/icons/IconMusicX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "music-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMusicX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMusicX$1 = IconMusicX;

export { IconMusicX$1 as default };
//# sourceMappingURL=IconMusicX.svelte.js.map
