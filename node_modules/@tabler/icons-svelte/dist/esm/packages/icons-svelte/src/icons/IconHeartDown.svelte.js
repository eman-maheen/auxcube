...
/* src/icons/IconHeartDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "heart-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHeartDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHeartDown$1 = IconHeartDown;

export { IconHeartDown$1 as default };
//# sourceMappingURL=IconHeartDown.svelte.js.map
