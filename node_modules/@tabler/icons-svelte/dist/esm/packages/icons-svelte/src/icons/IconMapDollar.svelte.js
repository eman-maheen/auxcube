...
/* src/icons/IconMapDollar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-dollar" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapDollar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapDollar$1 = IconMapDollar;

export { IconMapDollar$1 as default };
//# sourceMappingURL=IconMapDollar.svelte.js.map
