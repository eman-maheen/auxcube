...
/* src/icons/IconInputX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "input-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconInputX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconInputX$1 = IconInputX;

export { IconInputX$1 as default };
//# sourceMappingURL=IconInputX.svelte.js.map
