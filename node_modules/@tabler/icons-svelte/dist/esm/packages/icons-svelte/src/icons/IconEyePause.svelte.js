...
/* src/icons/IconEyePause.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "eye-pause" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEyePause extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEyePause$1 = IconEyePause;

export { IconEyePause$1 as default };
//# sourceMappingURL=IconEyePause.svelte.js.map
