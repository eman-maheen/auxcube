...
/* src/icons/IconFlagPause.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flag-pause" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlagPause extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlagPause$1 = IconFlagPause;

export { IconFlagPause$1 as default };
//# sourceMappingURL=IconFlagPause.svelte.js.map
