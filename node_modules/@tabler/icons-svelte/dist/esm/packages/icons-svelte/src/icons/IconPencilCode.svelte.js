...
/* src/icons/IconPencilCode.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pencil-code" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPencilCode extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPencilCode$1 = IconPencilCode;

export { IconPencilCode$1 as default };
//# sourceMappingURL=IconPencilCode.svelte.js.map
