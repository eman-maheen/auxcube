...
/* src/icons/IconBackslash.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "backslash" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M7 5l10 14" }]];
...
class IconBackslash extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBackslash$1 = IconBackslash;

export { IconBackslash$1 as default };
//# sourceMappingURL=IconBackslash.svelte.js.map
