...
/* src/icons/IconFrustumOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "frustum-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFrustumOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFrustumOff$1 = IconFrustumOff;

export { IconFrustumOff$1 as default };
//# sourceMappingURL=IconFrustumOff.svelte.js.map
