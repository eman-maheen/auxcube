...
/* src/icons/IconHeartCog.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "heart-cog" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHeartCog extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHeartCog$1 = IconHeartCog;

export { IconHeartCog$1 as default };
//# sourceMappingURL=IconHeartCog.svelte.js.map
