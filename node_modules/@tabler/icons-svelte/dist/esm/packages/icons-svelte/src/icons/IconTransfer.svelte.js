...
/* src/icons/IconTransfer.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "transfer" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M20 10h-16l5.5 -6" }], ["path", { "d": "M4 14h16l-5.5 6" }]];
...
class IconTransfer extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTransfer$1 = IconTransfer;

export { IconTransfer$1 as default };
//# sourceMappingURL=IconTransfer.svelte.js.map
