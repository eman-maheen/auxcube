...
/* src/icons/IconFrustum.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "frustum" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFrustum extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFrustum$1 = IconFrustum;

export { IconFrustum$1 as default };
//# sourceMappingURL=IconFrustum.svelte.js.map
