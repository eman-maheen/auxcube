...
/* src/icons/IconMapHeart.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-heart" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [
		[
			"path",
			{
				"d": "M10 17.5l-1 -.5l-6 3v-13l6 -3l6 3l6 -3v7"
			}
		],
		["path", { "d": "M9 4v13" }],
		["path", { "d": "M15 7v4" }],
...
class IconMapHeart extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapHeart$1 = IconMapHeart;

export { IconMapHeart$1 as default };
//# sourceMappingURL=IconMapHeart.svelte.js.map
