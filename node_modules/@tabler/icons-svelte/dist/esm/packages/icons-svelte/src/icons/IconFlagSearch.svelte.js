...
/* src/icons/IconFlagSearch.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flag-search" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlagSearch extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlagSearch$1 = IconFlagSearch;

export { IconFlagSearch$1 as default };
//# sourceMappingURL=IconFlagSearch.svelte.js.map
