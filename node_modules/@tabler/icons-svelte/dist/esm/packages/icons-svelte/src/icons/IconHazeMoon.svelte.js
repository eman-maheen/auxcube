...
/* src/icons/IconHazeMoon.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "haze-moon" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHazeMoon extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHazeMoon$1 = IconHazeMoon;

export { IconHazeMoon$1 as default };
//# sourceMappingURL=IconHazeMoon.svelte.js.map
