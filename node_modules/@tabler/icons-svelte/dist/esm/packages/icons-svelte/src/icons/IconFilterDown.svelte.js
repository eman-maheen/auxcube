...
/* src/icons/IconFilterDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "filter-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFilterDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFilterDown$1 = IconFilterDown;

export { IconFilterDown$1 as default };
//# sourceMappingURL=IconFilterDown.svelte.js.map
