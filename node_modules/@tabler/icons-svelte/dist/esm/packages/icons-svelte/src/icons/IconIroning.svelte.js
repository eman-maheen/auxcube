...
/* src/icons/IconIroning.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ironing" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconIroning extends SvelteComponent {
	constructor(options) {
		super();
...
var IconIroning$1 = IconIroning;

export { IconIroning$1 as default };
//# sourceMappingURL=IconIroning.svelte.js.map
