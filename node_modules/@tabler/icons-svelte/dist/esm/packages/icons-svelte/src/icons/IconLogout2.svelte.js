...
/* src/icons/IconLogout2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "logout-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLogout2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLogout2$1 = IconLogout2;

export { IconLogout2$1 as default };
//# sourceMappingURL=IconLogout2.svelte.js.map
