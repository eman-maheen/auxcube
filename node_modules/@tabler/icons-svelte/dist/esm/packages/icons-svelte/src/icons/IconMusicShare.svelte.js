...
/* src/icons/IconMusicShare.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "music-share" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMusicShare extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMusicShare$1 = IconMusicShare;

export { IconMusicShare$1 as default };
//# sourceMappingURL=IconMusicShare.svelte.js.map
