...
/* src/icons/IconFlagBolt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flag-bolt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlagBolt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlagBolt$1 = IconFlagBolt;

export { IconFlagBolt$1 as default };
//# sourceMappingURL=IconFlagBolt.svelte.js.map
