...
/* src/icons/IconPrismPlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "prism-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPrismPlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPrismPlus$1 = IconPrismPlus;

export { IconPrismPlus$1 as default };
//# sourceMappingURL=IconPrismPlus.svelte.js.map
