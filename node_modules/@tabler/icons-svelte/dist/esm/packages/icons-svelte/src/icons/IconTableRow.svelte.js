...
/* src/icons/IconTableRow.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "table-row" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTableRow extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTableRow$1 = IconTableRow;

export { IconTableRow$1 as default };
//# sourceMappingURL=IconTableRow.svelte.js.map
