...
/* src/icons/IconLocationX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "location-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLocationX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLocationX$1 = IconLocationX;

export { IconLocationX$1 as default };
//# sourceMappingURL=IconLocationX.svelte.js.map
