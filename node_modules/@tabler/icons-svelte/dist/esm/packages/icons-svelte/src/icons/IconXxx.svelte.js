...
/* src/icons/IconXxx.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "xxx" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconXxx extends SvelteComponent {
	constructor(options) {
		super();
...
var IconXxx$1 = IconXxx;

export { IconXxx$1 as default };
//# sourceMappingURL=IconXxx.svelte.js.map
