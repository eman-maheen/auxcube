...
/* src/icons/IconLocationUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "location-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLocationUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLocationUp$1 = IconLocationUp;

export { IconLocationUp$1 as default };
//# sourceMappingURL=IconLocationUp.svelte.js.map
