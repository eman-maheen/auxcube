...
/* src/icons/IconBasketDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "basket-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBasketDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBasketDown$1 = IconBasketDown;

export { IconBasketDown$1 as default };
//# sourceMappingURL=IconBasketDown.svelte.js.map
