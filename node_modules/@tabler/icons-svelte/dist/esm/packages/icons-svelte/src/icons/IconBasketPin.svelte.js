...
/* src/icons/IconBasketPin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "basket-pin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBasketPin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBasketPin$1 = IconBasketPin;

export { IconBasketPin$1 as default };
//# sourceMappingURL=IconBasketPin.svelte.js.map
