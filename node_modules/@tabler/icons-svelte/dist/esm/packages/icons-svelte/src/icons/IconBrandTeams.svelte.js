...
/* src/icons/IconBrandTeams.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-teams" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandTeams extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandTeams$1 = IconBrandTeams;

export { IconBrandTeams$1 as default };
//# sourceMappingURL=IconBrandTeams.svelte.js.map
