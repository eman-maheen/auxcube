...
/* src/icons/IconPencilPin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pencil-pin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPencilPin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPencilPin$1 = IconPencilPin;

export { IconPencilPin$1 as default };
//# sourceMappingURL=IconPencilPin.svelte.js.map
