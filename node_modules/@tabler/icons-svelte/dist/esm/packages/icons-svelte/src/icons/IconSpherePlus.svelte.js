...
/* src/icons/IconSpherePlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sphere-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSpherePlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSpherePlus$1 = IconSpherePlus;

export { IconSpherePlus$1 as default };
//# sourceMappingURL=IconSpherePlus.svelte.js.map
