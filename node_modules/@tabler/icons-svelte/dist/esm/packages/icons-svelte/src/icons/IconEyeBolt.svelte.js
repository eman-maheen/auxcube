...
/* src/icons/IconEyeBolt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "eye-bolt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEyeBolt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEyeBolt$1 = IconEyeBolt;

export { IconEyeBolt$1 as default };
//# sourceMappingURL=IconEyeBolt.svelte.js.map
