...
/* src/icons/IconMusicPin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "music-pin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMusicPin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMusicPin$1 = IconMusicPin;

export { IconMusicPin$1 as default };
//# sourceMappingURL=IconMusicPin.svelte.js.map
