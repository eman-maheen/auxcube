...
/* src/icons/IconCubePlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cube-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCubePlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCubePlus$1 = IconCubePlus;

export { IconCubePlus$1 as default };
//# sourceMappingURL=IconCubePlus.svelte.js.map
