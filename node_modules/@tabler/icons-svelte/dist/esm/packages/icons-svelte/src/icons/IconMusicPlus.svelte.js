...
/* src/icons/IconMusicPlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "music-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMusicPlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMusicPlus$1 = IconMusicPlus;

export { IconMusicPlus$1 as default };
//# sourceMappingURL=IconMusicPlus.svelte.js.map
