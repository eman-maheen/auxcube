...
/* src/icons/IconPencilCog.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pencil-cog" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPencilCog extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPencilCog$1 = IconPencilCog;

export { IconPencilCog$1 as default };
//# sourceMappingURL=IconPencilCog.svelte.js.map
