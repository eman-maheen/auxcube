...
/* src/icons/IconBrandX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandX$1 = IconBrandX;

export { IconBrandX$1 as default };
//# sourceMappingURL=IconBrandX.svelte.js.map
