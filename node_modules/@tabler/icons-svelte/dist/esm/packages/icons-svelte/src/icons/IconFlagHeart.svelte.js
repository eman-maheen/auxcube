...
/* src/icons/IconFlagHeart.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flag-heart" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlagHeart extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlagHeart$1 = IconFlagHeart;

export { IconFlagHeart$1 as default };
//# sourceMappingURL=IconFlagHeart.svelte.js.map
