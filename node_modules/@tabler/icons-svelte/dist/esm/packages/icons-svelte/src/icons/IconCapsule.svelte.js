...
/* src/icons/IconCapsule.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "capsule" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCapsule extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCapsule$1 = IconCapsule;

export { IconCapsule$1 as default };
//# sourceMappingURL=IconCapsule.svelte.js.map
