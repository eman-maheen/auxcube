...
/* src/icons/IconEyeCode.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "eye-code" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEyeCode extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEyeCode$1 = IconEyeCode;

export { IconEyeCode$1 as default };
//# sourceMappingURL=IconEyeCode.svelte.js.map
