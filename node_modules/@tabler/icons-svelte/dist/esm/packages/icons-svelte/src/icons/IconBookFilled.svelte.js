...
/* src/icons/IconBookFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "book-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBookFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBookFilled$1 = IconBookFilled;

export { IconBookFilled$1 as default };
//# sourceMappingURL=IconBookFilled.svelte.js.map
