...
/* src/icons/IconDiaboloOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "diabolo-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDiaboloOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDiaboloOff$1 = IconDiaboloOff;

export { IconDiaboloOff$1 as default };
//# sourceMappingURL=IconDiaboloOff.svelte.js.map
