...
/* src/icons/IconMapCancel.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-cancel" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [
		[
			"path",
			{
				"d": "M12 18.5l-3 -1.5l-6 3v-13l6 -3l6 3l6 -3v8"
			}
		],
		["path", { "d": "M9 4v13" }],
		["path", { "d": "M15 7v6" }],
...
class IconMapCancel extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapCancel$1 = IconMapCancel;

export { IconMapCancel$1 as default };
//# sourceMappingURL=IconMapCancel.svelte.js.map
