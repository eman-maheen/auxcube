...
/* src/icons/IconCube.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cube" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCube extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCube$1 = IconCube;

export { IconCube$1 as default };
//# sourceMappingURL=IconCube.svelte.js.map
