...
/* src/icons/IconQuotes.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "quotes" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconQuotes extends SvelteComponent {
	constructor(options) {
		super();
...
var IconQuotes$1 = IconQuotes;

export { IconQuotes$1 as default };
//# sourceMappingURL=IconQuotes.svelte.js.map
