...
/* src/icons/IconMapDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapDown$1 = IconMapDown;

export { IconMapDown$1 as default };
//# sourceMappingURL=IconMapDown.svelte.js.map
