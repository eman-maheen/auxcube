...
/* src/icons/IconCubeOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cube-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCubeOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCubeOff$1 = IconCubeOff;

export { IconCubeOff$1 as default };
//# sourceMappingURL=IconCubeOff.svelte.js.map
