...
/* src/icons/IconMapCog.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-cog" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapCog extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapCog$1 = IconMapCog;

export { IconMapCog$1 as default };
//# sourceMappingURL=IconMapCog.svelte.js.map
