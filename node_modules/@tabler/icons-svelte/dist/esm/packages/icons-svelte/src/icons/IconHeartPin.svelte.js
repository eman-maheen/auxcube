...
/* src/icons/IconHeartPin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "heart-pin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHeartPin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHeartPin$1 = IconHeartPin;

export { IconHeartPin$1 as default };
//# sourceMappingURL=IconHeartPin.svelte.js.map
