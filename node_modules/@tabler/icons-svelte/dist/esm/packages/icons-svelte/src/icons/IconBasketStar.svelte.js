...
/* src/icons/IconBasketStar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "basket-star" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [
		...
		[
			"path",
			{
				"d": "M13.596 12.794a2 2 0 0 0 -3.377 2.116"
			}
		],
		[
			"path",
...
class IconBasketStar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBasketStar$1 = IconBasketStar;

export { IconBasketStar$1 as default };
//# sourceMappingURL=IconBasketStar.svelte.js.map
