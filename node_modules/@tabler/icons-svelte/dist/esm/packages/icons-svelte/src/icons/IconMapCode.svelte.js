...
/* src/icons/IconMapCode.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-code" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapCode extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapCode$1 = IconMapCode;

export { IconMapCode$1 as default };
//# sourceMappingURL=IconMapCode.svelte.js.map
