...
/* src/icons/IconEyeShare.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "eye-share" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEyeShare extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEyeShare$1 = IconEyeShare;

export { IconEyeShare$1 as default };
//# sourceMappingURL=IconEyeShare.svelte.js.map
