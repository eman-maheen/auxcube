...
/* src/icons/IconMusicMinus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "music-minus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMusicMinus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMusicMinus$1 = IconMusicMinus;

export { IconMusicMinus$1 as default };
//# sourceMappingURL=IconMusicMinus.svelte.js.map
