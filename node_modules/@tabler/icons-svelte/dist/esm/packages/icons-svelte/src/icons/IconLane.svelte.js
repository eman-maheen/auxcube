...
/* src/icons/IconLane.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lane" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M4 6v13" }], ["path", { "d": "M20 6v13" }]];
...
class IconLane extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLane$1 = IconLane;

export { IconLane$1 as default };
//# sourceMappingURL=IconLane.svelte.js.map
