...
/* src/icons/IconMapWest.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-west" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapWest extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapWest$1 = IconMapWest;

export { IconMapWest$1 as default };
//# sourceMappingURL=IconMapWest.svelte.js.map
