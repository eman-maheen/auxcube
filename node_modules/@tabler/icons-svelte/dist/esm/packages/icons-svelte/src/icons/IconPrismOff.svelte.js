...
/* src/icons/IconPrismOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "prism-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPrismOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPrismOff$1 = IconPrismOff;

export { IconPrismOff$1 as default };
//# sourceMappingURL=IconPrismOff.svelte.js.map
