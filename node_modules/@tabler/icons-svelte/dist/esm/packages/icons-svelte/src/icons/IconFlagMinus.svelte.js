...
/* src/icons/IconFlagMinus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flag-minus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlagMinus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlagMinus$1 = IconFlagMinus;

export { IconFlagMinus$1 as default };
//# sourceMappingURL=IconFlagMinus.svelte.js.map
