...
/* src/icons/IconBrandVlc.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-vlc" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandVlc extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandVlc$1 = IconBrandVlc;

export { IconBrandVlc$1 as default };
//# sourceMappingURL=IconBrandVlc.svelte.js.map
