...
/* src/icons/IconHorse.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "horse" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHorse extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHorse$1 = IconHorse;

export { IconHorse$1 as default };
//# sourceMappingURL=IconHorse.svelte.js.map
