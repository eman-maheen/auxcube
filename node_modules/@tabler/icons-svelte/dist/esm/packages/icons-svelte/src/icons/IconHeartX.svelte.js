...
/* src/icons/IconHeartX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "heart-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHeartX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHeartX$1 = IconHeartX;

export { IconHeartX$1 as default };
//# sourceMappingURL=IconHeartX.svelte.js.map
