...
/* src/icons/IconPrism.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "prism" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPrism extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPrism$1 = IconPrism;

export { IconPrism$1 as default };
//# sourceMappingURL=IconPrism.svelte.js.map
