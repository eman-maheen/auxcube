...
/* src/icons/IconMusicBolt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "music-bolt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMusicBolt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMusicBolt$1 = IconMusicBolt;

export { IconMusicBolt$1 as default };
//# sourceMappingURL=IconMusicBolt.svelte.js.map
