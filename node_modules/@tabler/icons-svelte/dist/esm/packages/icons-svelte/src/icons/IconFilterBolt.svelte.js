...
/* src/icons/IconFilterBolt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "filter-bolt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFilterBolt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFilterBolt$1 = IconFilterBolt;

export { IconFilterBolt$1 as default };
//# sourceMappingURL=IconFilterBolt.svelte.js.map
