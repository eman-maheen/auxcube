...
/* src/icons/IconEyePin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "eye-pin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEyePin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEyePin$1 = IconEyePin;

export { IconEyePin$1 as default };
//# sourceMappingURL=IconEyePin.svelte.js.map
