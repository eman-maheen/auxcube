...
/* src/icons/IconMapCheck.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-check" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapCheck extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapCheck$1 = IconMapCheck;

export { IconMapCheck$1 as default };
//# sourceMappingURL=IconMapCheck.svelte.js.map
