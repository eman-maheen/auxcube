...
/* src/icons/IconMusicCheck.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "music-check" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMusicCheck extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMusicCheck$1 = IconMusicCheck;

export { IconMusicCheck$1 as default };
//# sourceMappingURL=IconMusicCheck.svelte.js.map
