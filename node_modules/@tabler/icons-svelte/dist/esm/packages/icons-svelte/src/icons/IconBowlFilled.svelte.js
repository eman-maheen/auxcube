...
/* src/icons/IconBowlFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bowl-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBowlFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBowlFilled$1 = IconBowlFilled;

export { IconBowlFilled$1 as default };
//# sourceMappingURL=IconBowlFilled.svelte.js.map
