...
/* src/icons/IconEyeSearch.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "eye-search" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEyeSearch extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEyeSearch$1 = IconEyeSearch;

export { IconEyeSearch$1 as default };
//# sourceMappingURL=IconEyeSearch.svelte.js.map
