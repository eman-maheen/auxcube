...
/* src/icons/IconFilterCode.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "filter-code" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFilterCode extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFilterCode$1 = IconFilterCode;

export { IconFilterCode$1 as default };
//# sourceMappingURL=IconFilterCode.svelte.js.map
