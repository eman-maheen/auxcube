...
/* src/icons/IconFlagShare.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flag-share" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlagShare extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlagShare$1 = IconFlagShare;

export { IconFlagShare$1 as default };
//# sourceMappingURL=IconFlagShare.svelte.js.map
