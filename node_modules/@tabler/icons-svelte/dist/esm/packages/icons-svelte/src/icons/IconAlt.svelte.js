...
/* src/icons/IconAlt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "alt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAlt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAlt$1 = IconAlt;

export { IconAlt$1 as default };
//# sourceMappingURL=IconAlt.svelte.js.map
