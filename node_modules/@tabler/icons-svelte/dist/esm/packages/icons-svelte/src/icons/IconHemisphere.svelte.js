...
/* src/icons/IconHemisphere.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "hemisphere" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHemisphere extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHemisphere$1 = IconHemisphere;

export { IconHemisphere$1 as default };
//# sourceMappingURL=IconHemisphere.svelte.js.map
