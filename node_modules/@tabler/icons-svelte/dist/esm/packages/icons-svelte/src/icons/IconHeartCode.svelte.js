...
/* src/icons/IconHeartCode.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "heart-code" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHeartCode extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHeartCode$1 = IconHeartCode;

export { IconHeartCode$1 as default };
//# sourceMappingURL=IconHeartCode.svelte.js.map
