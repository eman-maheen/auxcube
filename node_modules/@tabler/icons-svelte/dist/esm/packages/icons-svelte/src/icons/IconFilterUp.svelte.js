...
/* src/icons/IconFilterUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "filter-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFilterUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFilterUp$1 = IconFilterUp;

export { IconFilterUp$1 as default };
//# sourceMappingURL=IconFilterUp.svelte.js.map
