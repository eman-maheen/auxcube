...
/* src/icons/IconMenuDeep.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "menu-deep" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMenuDeep extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMenuDeep$1 = IconMenuDeep;

export { IconMenuDeep$1 as default };
//# sourceMappingURL=IconMenuDeep.svelte.js.map
