...
/* src/icons/IconEscalator.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "escalator" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEscalator extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEscalator$1 = IconEscalator;

export { IconEscalator$1 as default };
//# sourceMappingURL=IconEscalator.svelte.js.map
