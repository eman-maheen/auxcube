...
/* src/icons/IconConePlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cone-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconConePlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconConePlus$1 = IconConePlus;

export { IconConePlus$1 as default };
//# sourceMappingURL=IconConePlus.svelte.js.map
